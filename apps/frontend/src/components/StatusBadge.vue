...
// ai_queued/analyze_queued grouped with reading/enriching as in-flight (animated blue).
const STATUS_STYLES: Record<FileStatus, string> = {
  ...
  read: 'bg-sky-100 text-sky-800 border-transparent',
  ai_queued: 'bg-blue-100 text-blue-800 border-transparent animate-pulse',
  analyze_queued: 'bg-blue-100 text-blue-800 border-transparent animate-pulse',
  ...
  missing: 'bg-orange-100 text-orange-800 border-transparent',
}
